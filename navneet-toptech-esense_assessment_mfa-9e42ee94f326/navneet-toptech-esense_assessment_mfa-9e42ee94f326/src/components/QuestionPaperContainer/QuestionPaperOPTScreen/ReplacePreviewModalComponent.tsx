...
const ReplacePreviewModalComponent: FC<Props> = ({ header,updateSelection, modelOpen, setOpenPreview, selectedData, allFilters }) => {
    ...
    useEffect(() => {
        setSelectedAPIData(selectedData)
    }, [])
            ...
            <Modal
                ...
                <div className={`sup_tic_modpop`}>
                    ...
                    <Box className="d-flex justify-content-end mt-4" style={{gap: "15px"}}>
                        ...
                        <Box>
                            <ButtonComponent type="contained" buttonSize="Large" label="Replace" onClick={(e:any) => { updateSelection("prev",selectedAPIData?.id);handleClose()}}

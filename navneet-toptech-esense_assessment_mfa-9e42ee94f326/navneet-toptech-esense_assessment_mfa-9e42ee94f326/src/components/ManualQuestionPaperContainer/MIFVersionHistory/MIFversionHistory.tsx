...
import ViewDocument from '../../SharedComponents/ViewDocument/ViewDocument';
...
const MIFVersionHistory: React.FC<Props> = ({ questionPaperId, versionHistoryData }) => {
    ...
    React.useEffect(() => {
        if (versionHistoryData.length > 0) setSelectedVersion(versionHistoryData[0])
    }, [versionHistoryData])
...
export default MIFVersionHistory

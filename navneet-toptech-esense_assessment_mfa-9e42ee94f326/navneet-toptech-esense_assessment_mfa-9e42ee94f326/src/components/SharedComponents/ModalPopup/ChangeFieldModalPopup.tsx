...
const ChangeFieldModalPopup: FC<Props> =  ({ header, open,clickHandler,onClose,label1,label2,subHeader1,subHeader2}) => {  
    return (
        <>
            <Modal open={open} onClick={() => {clickHandler(true)}}>
...
export default ChangeFieldModalPopup;